...
func _ready() -> void:
	...
	add_child(vb)
	_add_btn(vb, "Planta", "Cenital (+Z sobre XY). Tecla 1 o Num 7", func() -> void: _rig.call("set_view_preset", "top"))
	_add_btn(vb, "Frente", "Hacia plano Y. Tecla 2 o Num 1", func() -> void: _rig.call("set_view_preset", "front"))
	_add_btn(vb, "Derecha", "Hacia plano X. Tecla 3 o Num 3", func() -> void: _rig.call("set_view_preset", "right"))
	_add_btn(vb, "Persp", "Perspectiva de trabajo. Tecla 4 o Num 0", func() -> void: _rig.call("set_view_preset", "persp"))
